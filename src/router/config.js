            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                path: '/apiCreate/productGroup',
                                name: '项目组',
                                component: lazy(() => import('../pages/apiCreate/productGroup'))
                            },
                            {
                                path: '/apiCreate/markManage',
                                name: '标记管理',
                                component: lazy(() => import('../pages/apiCreate/productGroup/markMange')),
                                hidden: true
                            },
                        ]
                    },
